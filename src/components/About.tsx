...
const About = () => {
  ...
  return <section id="about" className="py-20 relative" style={{
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          once: true
            ...
            <div className="space-y-4">
              ...
              <Card className="p-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 dark:bg-gradient-to-r dark:from-blue-500/10 dark:to-purple-500/10 light:bg-white backdrop-blur-xl border-white/10 hover:from-blue-500/20 hover:to-purple-500/20 transition-all duration-300">
              ...
              <Card className="p-6 bg-gradient-to-r from-green-500/10 to-blue-500/10 dark:bg-gradient-to-r dark:from-green-500/10 dark:to-blue-500/10 light:bg-white backdrop-blur-xl border-white/10 hover:from-green-500/20 hover:to-blue-500/20 transition-all duration-300">
                <div className="flex items-start space-x-4">
          ...
          once: true
            ...
            {/* Bio Section */}
            <Card className="p-8 bg-white/10 dark:bg-white/10 light:bg-white backdrop-blur-xl border-white/20 hover:bg-white/15 transition-all duration-300">
            ...
            once: true
              ...
              <Card className="p-6 bg-white/10 dark:bg-white/10 light:bg-white backdrop-blur-xl border-white/20">
                <h4 className="text-xl font-semibold text-white dark:text-white light:text-gray-900 mb-4">Areas of Interest</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {areasOfInterest.map((area, index) => <motion.div key={area.name} initial={{
                  opacity: 0,
                  x: -20
                }} whileInView={{
                  opacity: 1,
