...
const Experience = () => {
  const experiences = [{
    ...
    location: 'Texas, USA',
    responsibilities: ['Facilitated student comprehension of fundamental programming concepts', 'Mentoring students in computer science fundamentals', 'Session planning and curriculum development', 'Collaborative learning facilitation'],
    ...
    period: 'Jul – Aug 2023',
    location: 'Cameroon',
    responsibilities: ['Technical support and troubleshooting', 'Documentation and process improvement', 'Customer service and client relations', 'System maintenance and optimization'],
    ...
    period: 'Ongoing',
    location: 'Remote',
    responsibilities: ['Web design and development', 'Mobile application development', 'Database management and optimization', 'Client consultation and project management'],
    color: 'from-purple-500 to-pink-500'
  }];
  return <section id="experience" className="py-20 relative" style={{
    ...
    backgroundAttachment: 'fixed'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="space-y-8 mb-16">
          {experiences.map((experience, index) => <motion.div key={experience.title} initial={{
          opacity: 0,
          x: index % 2 === 0 ? -50 : 50
        }} whileInView={{
          opacity: 1,
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:space-x-8">
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="space-y-3">
                      {experience.responsibilities.map((responsibility, respIndex) => <motion.div key={respIndex} initial={{
                    opacity: 0,
                    x: -20
                  }} whileInView={{
                    opacity: 1,
          ...
          <Card className="p-8 bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-xl border-white/20">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0 md:space-x-8">
              ...
              <div className="flex-1 max-w-md">
                <div className="bg-white/10 border border-white/20 rounded-lg p-6 hover:bg-white/15 transition-all duration-300 cursor-pointer mx-[85px]">
